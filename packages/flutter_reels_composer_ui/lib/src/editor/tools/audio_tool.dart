...
class _AudioToolPanelState extends State<AudioToolPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    // Preview playback is owned by LocalPreviewPort.
    return SizedBox(
        ...
        children: [
              ...
              children: [
                ...
                if (_hasSelection)
                  TextButton(
                    onPressed: () => _select(),
                    child: Text(
                      context.composerL10n.text('remove'),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        context.composerL10n.text('musicTrack'),
                        style: TextStyle(
                          color: widget.theme.muted,
                          fontSize: 11,
                        ),
          ...
          if (_hasSelection)
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.skip_next, color: widget.theme.muted, size: 18),
              ...
              children: [
                ListTile(
                  ...
                  leading: _picking
                      ...
                      : Icon(Icons.library_music, color: widget.theme.accent),
                  title: Text(
                    context.composerL10n.text('chooseFromDevice'),
                    style: const TextStyle(color: Colors.white),
                  ),
                  subtitle: Text(
                    _importedTitle ?? context.composerL10n.text('audioFormats'),
